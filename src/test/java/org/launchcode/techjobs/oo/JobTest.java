...
public class JobTest {
    ...
    public void testToStringContainsCorrectLabelsAndData() {
        ...
        String printResult =
                lineSeparator() + "ID: " + job_six.getId() +
                lineSeparator() + "Name: " + "Test Job" +
                lineSeparator() + "Employer: " + "Test Employer" +
                lineSeparator() + "Location: " + "The Testing Place" +
                lineSeparator() + "Position Type: " + "Test Tester" +
                lineSeparator() + "Core Competency: " + "Testing Tests" +
                lineSeparator();
